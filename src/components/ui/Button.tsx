  ...
  "relative flex cursor-pointer items-center justify-center rounded-full transition-all  gap-2 text-sm font-medium hover:opacity-90 duration-300 hover:shadow-[--card-shadow-2] ease-in-out group",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-gradient-to-t from-neutral-400 to-neutral-300 dark:from-neutral-700 dark:to-neutral-800 dark:border-neutral-700 border border-neutral-200 text-primary-foreground shadow-xs hover:bg-primary/90",
        tertiary:
